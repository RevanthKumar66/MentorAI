    ...
    <div className="flex-1 flex flex-col justify-center items-center bg-[#fcfbf9] px-4 py-12">
      <div className="w-full max-w-[380px] bg-white border border-slate-200/80 p-8 rounded-[6px]">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-lg font-bold tracking-tight text-slate-900">Welcome back</h2>
          <p className="text-[11px] text-slate-500 mt-1">Sign in to your MentorAI OS account</p>
        </div>

        {/* Email Not Verified Banner */}
        {needsVerification && (
          <div className="mb-4 p-3 rounded-[6px] bg-amber-50 border border-amber-200 text-amber-900 text-[11px]">
            ...
            {resendSent ? (
              ...
              <button
                ...
                className="mt-1 text-amber-800 underline font-semibold hover:text-amber-900 disabled:opacity-50 cursor-pointer transition-colors"
              >
        ...
        {/* Google Authentication — above email form for prominence */}
        <button
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider mx-3">or sign in with email</span>
          <span className="flex-1 border-b border-slate-200"></span>
        </div>
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          ...
          <Link href="/signup" className="text-slate-900 hover:underline font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </div>
