    ...
    <main className="w-full px-14 py-6 space-y-6 animate-fade-in">
      ...
      {latestCoachMessage && (
        <div className="bg-gradient-to-r from-amber-50/60 to-orange-50/40 border border-amber-200 rounded-[12px] p-4 flex items-start gap-3 hover:border-amber-300 transition-colors shadow-sm relative overflow-hidden group">
          ...
          <Link
            href="/mentors/momentum/execution"
      ...
      {(focusScore !== null || goalHealthList.length > 0) && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {focusScore !== null && (
            <Link href="/mentors/momentum/focus" className="block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Risk Summary Widget */}
        <Link href="/mentors/momentum/risk" className="flex items-center gap-3 p-3 bg-white border border-slate-200/60 rounded-[8px] h-14 hover:border-slate-350 transition-colors">
        ...
        {/* Most At Risk Goal */}
        {mostAtRiskGoal ? (
          <Link href="/mentors/momentum/risk" className="flex items-center gap-3 p-3 bg-white border border-slate-200/60 rounded-[8px] h-14 hover:border-slate-350 transition-colors min-w-0">
      ...
      {goalHealthList.length > 0 && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="/mentors/momentum/focus" className="text-[9.5px] font-semibold text-slate-700 hover:text-slate-955">Full Analysis →</Link>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="space-y-4">
            ...
            {activeGoals.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {activeGoals.slice(0, 4).map((goal) => (
                  <GoalCard
                    ...
                    onEdit={() => { window.location.href = '/mentors/momentum/goals'; }}
              ...
              <EmptyState
                ...
                onAction={() => { window.location.href = '/mentors/momentum/goals?action=create'; }}
              />
            )}
          </div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-[12px] p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {[
                { href: '/mentors/momentum/planner', label: 'Generate AI Roadmap', sub: 'AI week-by-week plan', icon: Sparkles },
                { href: '/mentors/momentum/goals?action=create', label: 'Create New Goal', sub: 'Establish a milestone', icon: PlusCircle },
                { href: '/mentors/momentum/tasks?action=create', label: 'Create New Task', sub: 'Add a subtask list', icon: PlusCircle },
                { href: '/mentors/momentum/ai-center', label: 'AI Center', sub: 'Planner, Focus, Risk & Execution', icon: Zap },
                { href: '/mentors/momentum/risk', label: 'Risk Center', sub: 'Predict & prevent goal failure', icon: AlertTriangle },
                { href: '/mentors/momentum/execution', label: 'Execution Agent', sub: 'AI Chief of Staff console', icon: Cpu },
        ...
        <div className="space-y-4">
          ...
          {pendingTasks.length > 0 ? (
            <div className="flex flex-col gap-3">
              {pendingTasks.slice(0, 5).map((task) => (
                <TaskCard
                  ...
                  onEdit={() => { window.location.href = `/mentors/momentum/tasks?edit=${task.id}`; }}
            ...
            <EmptyState
              ...
              onAction={() => { window.location.href = '/mentors/momentum/tasks?action=create'; }}
            />
          )}
        </div>
      </div>
