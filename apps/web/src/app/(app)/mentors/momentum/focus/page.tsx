    ...
    return (
      <main className="w-full px-14 py-6">
        <div className="bg-white border border-slate-200/60 rounded-[12px] p-10 text-center space-y-4">
          ...
          <Link href="/mentors/momentum/planner" className="inline-flex py-2 px-4 rounded-[6px] bg-slate-950 text-white text-[10px] font-semibold hover:bg-slate-900 transition-colors">
            Generate AI Roadmap
          </Link>
        </div>
      </main>
