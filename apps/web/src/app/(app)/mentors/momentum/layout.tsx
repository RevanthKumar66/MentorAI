...
import {
  ...
  Menu, X, Bell, Settings, User, PanelLeftClose, PanelLeft, ArrowLeft, Zap, Mail
} from 'lucide-react';
...
export default function MomentumAILayout({ children }: { children: React.ReactNode }) {
  ...
  // Close mobile drawer on route change asynchronously to avoid synchronous cascading renders
  useEffect(() => {
    if (mobileMenuOpen) {
  ...
  const workspaceItems = [
    { name: 'Dashboard', href: '/mentors/momentum', icon: LayoutDashboard },
  ];

  const productivityItems = [
    { name: 'Goals', href: '/mentors/momentum/goals', icon: Flag },
    { name: 'Tasks', href: '/mentors/momentum/tasks', icon: CheckSquare },
  ];

  const aiCenterItems = [
    { name: 'AI Planner', href: '/mentors/momentum/planner', icon: Sparkles },
    { name: 'Focus AI', href: '/mentors/momentum/focus', icon: Crosshair },
    { name: 'Risk Center', href: '/mentors/momentum/risk', icon: AlertTriangle },
    { name: 'Execution Agent', href: '/mentors/momentum/execution', icon: Cpu },
    { name: 'Smart Scheduling', href: '/mentors/momentum/scheduling', icon: Calendar },
    { name: 'Email Intelligence', href: '/mentors/momentum/email', icon: Mail },
    { name: 'Agent Hub', href: '/mentors/momentum/agent', icon: Bot },
  ];

  const systemItems = [
    { name: 'Settings', href: '/mentors/momentum/settings', icon: Settings },
    { name: 'Profile', href: '/mentors/momentum/profile', icon: User },
  ];
